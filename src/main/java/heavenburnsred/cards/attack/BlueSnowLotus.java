...
public class BlueSnowLotus extends HBRHitAndTypeAttackCard {
    public static final String ID = makeID(BlueSnowLotus.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    private static final int HIT_INC = 40;

    public BlueSnowLotus() {
        super(ID,info,HBRAttackType.LQ);
