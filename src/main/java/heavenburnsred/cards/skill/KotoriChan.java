...
public class KotoriChan extends BaseCard {
    public static final String ID = makeID(KotoriChan.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new FreeModCardPower(p, 1), 1));
    }
}
